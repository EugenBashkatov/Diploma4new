...
def build_graph_with_clusters(start_point, max_dim, DEBUG = False):
    ...
    while True:
        ...
        while x1 <= max_dim - 2:
            ...
            #TODO Fill cluster square
            if DEBUG1:print("DEBUG_1:From= ", x0, "To= ", x1, "k= ", vis_k, "Next= ", x2, "next_k=", vis_k_next,"cluster_size=", cluster_size)
            ...
            if is_growing:
                ...
                # Вершина вхоит в x0 кластер? -нет
                #graph_array[x0][x1] = cluster_size
                cluster_size = 1
